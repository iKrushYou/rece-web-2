        ...
        <List>
          {people.map((person) => (
            <ListItem key={person.id}>
              <Box sx={{ display: 'flex', alignItems: 'center', width: '100%', gap: 2 }}>
                ...
                <ButtonBase sx={{ width: '100%', textAlign: 'inherit' }} onClick={() => {
                  showEditTextModal({
                    title: 'Edit Person',
                    value: person.name,
                  ...
                  <Typography variant={'h5'} sx={{ flex: 1 }}>{person.name}</Typography>
                </ButtonBase>
          ...
          <ListItem>
            <Box sx={{ display: 'flex', alignItems: 'center', width: '100%', gap: 2 }}>
              ...
              <TextField variant={'standard'} inputRef={newPersonFieldRef} onKeyDown={handleOnKeyDown}
